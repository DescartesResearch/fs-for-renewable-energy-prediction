...
group = parser.add_argument_group('General required settings')
group.add_argument('--name', type=str,
                   help='Experiment name used for logging', required=True)
group.add_argument('--domain', type=str, required=True, help='The domain of the experiment. Possible values: wind, pv')
...
group.add_argument('--features', type=str,
                   help=f'One of {Constants.FEATURE_SET_TYPES}', required=True)
group.add_argument('--fs_method', type=str,
                   help=f'Feature selection method. Must be in {Constants.FS_METHODS}', required=True)
group.add_argument('--n_features', type=int,
                   help='Number of features to select', required=True)
...
group = parser.add_argument_group('CSFS and SFS settings')
...
group = parser.add_argument_group('Hyperparameter optimization settings')
...
group = parser.add_argument_group('HPO warm starts settings')
...
group = parser.add_argument_group('Cross-validation settings')
...
group = parser.add_argument_group('Evaluation/Prediction settings')
...
group.add_argument('--random_seed', type=int, help='The random seed set prior to the experiments.', required=True)

group = parser.add_argument_group('Special run modes')
group.add_argument('--estimate_HPO_time', action='store_true',
                   help='If set, only estimate the required time budgets for the given models, does not run the actual experiments.')
